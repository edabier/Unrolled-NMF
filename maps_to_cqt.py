...
"""
This code saves the MAPS dataset locally as torch tensors and creates a csv file with the location of every file
...
def save_audio(metadata_list, row, save_path, hop_length=128, dtype=None):
    """
