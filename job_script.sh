...
#SBATCH --time=10:00:00                # Time limit for the job (hh:mm:ss)
...
# srun python /home/ids/edabier/AMT/Unrolled-NMF/test_trainer.py --num_workers $N_WORKERS --iter $ITER --lr $LR --epochs $EPOCHS --batch $BATCH_SIZE --length $LENGTH --subset $SUBSET --split $SPLIT
